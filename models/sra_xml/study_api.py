...
#
# Generated Mon Mar 13 15:45:47 2017 by generateDS.py version 2.16a.
#
...
#   sra_schema_files/SRA.study.xsd
#
# Command line:
#   /home/gemmy/generateDS-2.16a0/generateDS.py -f -o "study_api.py" sra_schema_files/SRA.study.xsd
#
...
class StudySetType(GeneratedsSuper):
    ...
    def insert_STUDY_at(self, index, value): self.STUDY.insert(index, value)
    def replace_STUDY_at(self, index, value): self.STUDY[index] = value
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='StudySetType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='StudySetType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='StudySetType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='StudySetType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='StudySetType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for STUDY_ in self.STUDY:
            STUDY_.export(outfile, level, namespace_, name_='STUDY', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='StudySetType'):
        level += 1
        already_processed = set()
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for STUDY_ in self.STUDY:
            showIndent(outfile, level)
            outfile.write('model_.StudyType(\n')
            STUDY_.exportLiteral(outfile, level, name_='StudyType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class DESCRIPTORType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, STUDY_TITLE=None, STUDY_TYPE=None, STUDY_ABSTRACT=None, CENTER_NAME=None, CENTER_PROJECT_NAME=None, PROJECT_ID=None, RELATED_STUDIES=None, STUDY_DESCRIPTION=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_STUDY_TITLE(self): return self.STUDY_TITLE
    def set_STUDY_TITLE(self, STUDY_TITLE): self.STUDY_TITLE = STUDY_TITLE
    def get_STUDY_TYPE(self): return self.STUDY_TYPE
    def set_STUDY_TYPE(self, STUDY_TYPE): self.STUDY_TYPE = STUDY_TYPE
    def get_STUDY_ABSTRACT(self): return self.STUDY_ABSTRACT
    def set_STUDY_ABSTRACT(self, STUDY_ABSTRACT): self.STUDY_ABSTRACT = STUDY_ABSTRACT
    def get_CENTER_NAME(self): return self.CENTER_NAME
    def set_CENTER_NAME(self, CENTER_NAME): self.CENTER_NAME = CENTER_NAME
    def get_CENTER_PROJECT_NAME(self): return self.CENTER_PROJECT_NAME
    def set_CENTER_PROJECT_NAME(self, CENTER_PROJECT_NAME): self.CENTER_PROJECT_NAME = CENTER_PROJECT_NAME
    def get_PROJECT_ID(self): return self.PROJECT_ID
    def set_PROJECT_ID(self, PROJECT_ID): self.PROJECT_ID = PROJECT_ID
    def get_RELATED_STUDIES(self): return self.RELATED_STUDIES
    def set_RELATED_STUDIES(self, RELATED_STUDIES): self.RELATED_STUDIES = RELATED_STUDIES
    def get_STUDY_DESCRIPTION(self): return self.STUDY_DESCRIPTION
    def set_STUDY_DESCRIPTION(self, STUDY_DESCRIPTION): self.STUDY_DESCRIPTION = STUDY_DESCRIPTION
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='DESCRIPTORType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DESCRIPTORType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='DESCRIPTORType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='DESCRIPTORType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='DESCRIPTORType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.STUDY_TITLE is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSTUDY_TITLE>%s</%sSTUDY_TITLE>%s' % (namespace_, self.gds_format_string(quote_xml(self.STUDY_TITLE).encode(ExternalEncoding), input_name='STUDY_TITLE'), namespace_, eol_))
        if self.STUDY_TYPE is not None:
            self.STUDY_TYPE.export(outfile, level, namespace_, name_='STUDY_TYPE', pretty_print=pretty_print)
        if self.STUDY_ABSTRACT is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSTUDY_ABSTRACT>%s</%sSTUDY_ABSTRACT>%s' % (namespace_, self.gds_format_string(quote_xml(self.STUDY_ABSTRACT).encode(ExternalEncoding), input_name='STUDY_ABSTRACT'), namespace_, eol_))
        if self.CENTER_NAME is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCENTER_NAME>%s</%sCENTER_NAME>%s' % (namespace_, self.gds_format_string(quote_xml(self.CENTER_NAME).encode(ExternalEncoding), input_name='CENTER_NAME'), namespace_, eol_))
        if self.CENTER_PROJECT_NAME is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCENTER_PROJECT_NAME>%s</%sCENTER_PROJECT_NAME>%s' % (namespace_, self.gds_format_string(quote_xml(self.CENTER_PROJECT_NAME).encode(ExternalEncoding), input_name='CENTER_PROJECT_NAME'), namespace_, eol_))
        if self.PROJECT_ID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPROJECT_ID>%s</%sPROJECT_ID>%s' % (namespace_, self.gds_format_integer(self.PROJECT_ID, input_name='PROJECT_ID'), namespace_, eol_))
        if self.RELATED_STUDIES is not None:
            self.RELATED_STUDIES.export(outfile, level, namespace_, name_='RELATED_STUDIES', pretty_print=pretty_print)
        if self.STUDY_DESCRIPTION is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSTUDY_DESCRIPTION>%s</%sSTUDY_DESCRIPTION>%s' % (namespace_, self.gds_format_string(quote_xml(self.STUDY_DESCRIPTION).encode(ExternalEncoding), input_name='STUDY_DESCRIPTION'), namespace_, eol_))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.STUDY_TITLE is not None:
            showIndent(outfile, level)
            outfile.write('STUDY_TITLE=%s,\n' % quote_python(self.STUDY_TITLE).encode(ExternalEncoding))
        if self.STUDY_TYPE is not None:
            showIndent(outfile, level)
            outfile.write('STUDY_TYPE=model_.STUDY_TYPEType(\n')
            self.STUDY_TYPE.exportLiteral(outfile, level, name_='STUDY_TYPE')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.STUDY_ABSTRACT is not None:
            showIndent(outfile, level)
            outfile.write('STUDY_ABSTRACT=%s,\n' % quote_python(self.STUDY_ABSTRACT).encode(ExternalEncoding))
        if self.CENTER_NAME is not None:
            showIndent(outfile, level)
            outfile.write('CENTER_NAME=%s,\n' % quote_python(self.CENTER_NAME).encode(ExternalEncoding))
        if self.CENTER_PROJECT_NAME is not None:
            showIndent(outfile, level)
            outfile.write('CENTER_PROJECT_NAME=%s,\n' % quote_python(self.CENTER_PROJECT_NAME).encode(ExternalEncoding))
        if self.PROJECT_ID is not None:
            showIndent(outfile, level)
            outfile.write('PROJECT_ID=%d,\n' % self.PROJECT_ID)
        if self.RELATED_STUDIES is not None:
            showIndent(outfile, level)
            outfile.write('RELATED_STUDIES=model_.RELATED_STUDIESType(\n')
            self.RELATED_STUDIES.exportLiteral(outfile, level, name_='RELATED_STUDIES')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.STUDY_DESCRIPTION is not None:
            showIndent(outfile, level)
            outfile.write('STUDY_DESCRIPTION=%s,\n' % quote_python(self.STUDY_DESCRIPTION).encode(ExternalEncoding))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'STUDY_TITLE':
            STUDY_TITLE_ = child_.text
            STUDY_TITLE_ = self.gds_validate_string(STUDY_TITLE_, node, 'STUDY_TITLE')
            self.STUDY_TITLE = STUDY_TITLE_
        elif nodeName_ == 'STUDY_TYPE':
            obj_ = STUDY_TYPEType.factory()
            obj_.build(child_)
            self.STUDY_TYPE = obj_
            obj_.original_tagname_ = 'STUDY_TYPE'
        elif nodeName_ == 'STUDY_ABSTRACT':
            STUDY_ABSTRACT_ = child_.text
            STUDY_ABSTRACT_ = self.gds_validate_string(STUDY_ABSTRACT_, node, 'STUDY_ABSTRACT')
            self.STUDY_ABSTRACT = STUDY_ABSTRACT_
        elif nodeName_ == 'CENTER_NAME':
            CENTER_NAME_ = child_.text
            CENTER_NAME_ = self.gds_validate_string(CENTER_NAME_, node, 'CENTER_NAME')
            self.CENTER_NAME = CENTER_NAME_
        elif nodeName_ == 'CENTER_PROJECT_NAME':
            CENTER_PROJECT_NAME_ = child_.text
            CENTER_PROJECT_NAME_ = self.gds_validate_string(CENTER_PROJECT_NAME_, node, 'CENTER_PROJECT_NAME')
            self.CENTER_PROJECT_NAME = CENTER_PROJECT_NAME_
            ...
            obj_ = RELATED_STUDIESType.factory()
            obj_.build(child_)
            self.RELATED_STUDIES = obj_
            obj_.original_tagname_ = 'RELATED_STUDIES'
        elif nodeName_ == 'STUDY_DESCRIPTION':
            STUDY_DESCRIPTION_ = child_.text
            STUDY_DESCRIPTION_ = self.gds_validate_string(STUDY_DESCRIPTION_, node, 'STUDY_DESCRIPTION')
            self.STUDY_DESCRIPTION = STUDY_DESCRIPTION_
# end class DESCRIPTORType


class STUDY_TYPEType(GeneratedsSuper):
    """Sequencing of a single organism. Sequencing of a community.
    Sequencing and characterization of transcription elements.
    Sequencing of a sample with respect to a reference. Cellular
    differentiation study. Sequencing of modified, synthetic, or
    transplanted genomes. Sequencing of recovered genomic material.
    Study of gene expression regulation. Study of cancer genomics.
    Study of populations and evolution through genomics. RNA
    sequencing study. The study investigates the exons of the
    genome. The study is sequencing clone pools (BACs, fosmids,
    other constructs). Study type not listed. To propose a new term,
    select Other and enter a new study type."""
    subclass = None
    superclass = None
    def __init__(self, new_study_type=None, existing_study_type=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_new_study_type(self): return self.new_study_type
    def set_new_study_type(self, new_study_type): self.new_study_type = new_study_type
    def get_existing_study_type(self): return self.existing_study_type
    def set_existing_study_type(self, existing_study_type): self.existing_study_type = existing_study_type
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='STUDY_TYPEType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='STUDY_TYPEType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='STUDY_TYPEType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='STUDY_TYPEType'):
        if self.new_study_type is not None and 'new_study_type' not in already_processed:
            already_processed.add('new_study_type')
            outfile.write(' new_study_type=%s' % (self.gds_format_string(quote_attrib(self.new_study_type).encode(ExternalEncoding), input_name='new_study_type'), ))
        if self.existing_study_type is not None and 'existing_study_type' not in already_processed:
            ...
            outfile.write(' existing_study_type=%s' % (self.gds_format_string(quote_attrib(self.existing_study_type).encode(ExternalEncoding), input_name='existing_study_type'), ))
    def exportChildren(self, outfile, level, namespace_='', name_='STUDY_TYPEType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='STUDY_TYPEType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.new_study_type is not None and 'new_study_type' not in already_processed:
            already_processed.add('new_study_type')
            showIndent(outfile, level)
            outfile.write('new_study_type="%s",\n' % (self.new_study_type,))
        if self.existing_study_type is not None and 'existing_study_type' not in already_processed:
            already_processed.add('existing_study_type')
            showIndent(outfile, level)
            outfile.write('existing_study_type="%s",\n' % (self.existing_study_type,))
    def exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node):
        already_processed = set()
...
class RELATED_STUDIESType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, RELATED_STUDY=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_RELATED_STUDY(self): return self.RELATED_STUDY
    def set_RELATED_STUDY(self, RELATED_STUDY): self.RELATED_STUDY = RELATED_STUDY
    def add_RELATED_STUDY(self, value): self.RELATED_STUDY.append(value)
    def insert_RELATED_STUDY_at(self, index, value): self.RELATED_STUDY.insert(index, value)
    def replace_RELATED_STUDY_at(self, index, value): self.RELATED_STUDY[index] = value
    def hasContent_(self):
        if (
            self.RELATED_STUDY
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='RELATED_STUDIESType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RELATED_STUDIESType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='RELATED_STUDIESType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='RELATED_STUDIESType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='RELATED_STUDIESType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for RELATED_STUDY_ in self.RELATED_STUDY:
            RELATED_STUDY_.export(outfile, level, namespace_, name_='RELATED_STUDY', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='RELATED_STUDIESType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('RELATED_STUDY=[\n')
        level += 1
        for RELATED_STUDY_ in self.RELATED_STUDY:
            showIndent(outfile, level)
            outfile.write('model_.RELATED_STUDYType(\n')
            RELATED_STUDY_.exportLiteral(outfile, level, name_='RELATED_STUDYType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'RELATED_STUDY':
            obj_ = RELATED_STUDYType.factory()
            obj_.build(child_)
...
class RELATED_STUDYType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, RELATED_LINK=None, IS_PRIMARY=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_RELATED_LINK(self): return self.RELATED_LINK
    def set_RELATED_LINK(self, RELATED_LINK): self.RELATED_LINK = RELATED_LINK
    def get_IS_PRIMARY(self): return self.IS_PRIMARY
    def set_IS_PRIMARY(self, IS_PRIMARY): self.IS_PRIMARY = IS_PRIMARY
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='RELATED_STUDYType', namespacedef_=' xmlns:com="SRA.common" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RELATED_STUDYType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='RELATED_STUDYType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='RELATED_STUDYType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='RELATED_STUDYType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.RELATED_LINK is not None:
            self.RELATED_LINK.export(outfile, level, namespace_, name_='RELATED_LINK', pretty_print=pretty_print)
        if self.IS_PRIMARY is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sIS_PRIMARY>%s</%sIS_PRIMARY>%s' % (namespace_, self.gds_format_boolean(self.IS_PRIMARY, input_name='IS_PRIMARY'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='RELATED_STUDYType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.RELATED_LINK is not None:
            showIndent(outfile, level)
            outfile.write('RELATED_LINK=model_.XRefType(\n')
            self.RELATED_LINK.exportLiteral(outfile, level, name_='RELATED_LINK')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IS_PRIMARY is not None:
            showIndent(outfile, level)
            outfile.write('IS_PRIMARY=%s,\n' % self.IS_PRIMARY)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class STUDY_LINKSType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, STUDY_LINK=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_STUDY_LINK(self): return self.STUDY_LINK
    def set_STUDY_LINK(self, STUDY_LINK): self.STUDY_LINK = STUDY_LINK
    def add_STUDY_LINK(self, value): self.STUDY_LINK.append(value)
    def insert_STUDY_LINK_at(self, index, value): self.STUDY_LINK.insert(index, value)
    def replace_STUDY_LINK_at(self, index, value): self.STUDY_LINK[index] = value
    def hasContent_(self):
        if (
            self.STUDY_LINK
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='STUDY_LINKSType', namespacedef_=' xmlns:com="SRA.common" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='STUDY_LINKSType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='STUDY_LINKSType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='STUDY_LINKSType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='STUDY_LINKSType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for STUDY_LINK_ in self.STUDY_LINK:
            STUDY_LINK_.export(outfile, level, namespace_, name_='STUDY_LINK', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='STUDY_LINKSType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('STUDY_LINK=[\n')
        level += 1
        for STUDY_LINK_ in self.STUDY_LINK:
            showIndent(outfile, level)
            outfile.write('model_.LinkType(\n')
            STUDY_LINK_.exportLiteral(outfile, level, name_='LinkType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class STUDY_ATTRIBUTESType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, STUDY_ATTRIBUTE=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_STUDY_ATTRIBUTE(self): return self.STUDY_ATTRIBUTE
    def set_STUDY_ATTRIBUTE(self, STUDY_ATTRIBUTE): self.STUDY_ATTRIBUTE = STUDY_ATTRIBUTE
    def add_STUDY_ATTRIBUTE(self, value): self.STUDY_ATTRIBUTE.append(value)
    def insert_STUDY_ATTRIBUTE_at(self, index, value): self.STUDY_ATTRIBUTE.insert(index, value)
    def replace_STUDY_ATTRIBUTE_at(self, index, value): self.STUDY_ATTRIBUTE[index] = value
    def hasContent_(self):
        if (
            self.STUDY_ATTRIBUTE
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='STUDY_ATTRIBUTESType', namespacedef_=' xmlns:com="SRA.common" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='STUDY_ATTRIBUTESType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='STUDY_ATTRIBUTESType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='STUDY_ATTRIBUTESType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='STUDY_ATTRIBUTESType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for STUDY_ATTRIBUTE_ in self.STUDY_ATTRIBUTE:
            STUDY_ATTRIBUTE_.export(outfile, level, namespace_, name_='STUDY_ATTRIBUTE', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='STUDY_ATTRIBUTESType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('STUDY_ATTRIBUTE=[\n')
        level += 1
        for STUDY_ATTRIBUTE_ in self.STUDY_ATTRIBUTE:
            showIndent(outfile, level)
            outfile.write('model_.AttributeType(\n')
            STUDY_ATTRIBUTE_.exportLiteral(outfile, level, name_='AttributeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class StudyType(ObjectType):
    """A Study is a container for a sequencing investigation that may
    comprise multiple experiments. The Study has an overall goal,
    but is otherwise minimally defined in the SRA. A Study is
    composed of a descriptor, zero or more experiments, and zero or
    more analyses. The submitter may decorate the Study with web
    links and properties."""
    subclass = None
    superclass = ObjectType
    def __init__(self, center_name=None, alias=None, broker_name=None, accession=None, IDENTIFIERS=None, DESCRIPTOR=None, STUDY_LINKS=None, STUDY_ATTRIBUTES=None):
        self.original_tagname_ = None
        super(StudyType, self).__init__(center_name, alias, broker_name, accession, IDENTIFIERS, )
    ...
    def get_STUDY_LINKS(self): return self.STUDY_LINKS
    def set_STUDY_LINKS(self, STUDY_LINKS): self.STUDY_LINKS = STUDY_LINKS
    def get_STUDY_ATTRIBUTES(self): return self.STUDY_ATTRIBUTES
    def set_STUDY_ATTRIBUTES(self, STUDY_ATTRIBUTES): self.STUDY_ATTRIBUTES = STUDY_ATTRIBUTES
    def hasContent_(self):
        if (
            self.DESCRIPTOR is not None or
            self.STUDY_LINKS is not None or
            self.STUDY_ATTRIBUTES is not None or
            super(StudyType, self).hasContent_()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='StudyType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='StudyType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='StudyType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='StudyType'):
        super(StudyType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='StudyType')
    def exportChildren(self, outfile, level, namespace_='', name_='StudyType', fromsubclass_=False, pretty_print=True):
        super(StudyType, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.STUDY_LINKS is not None:
            self.STUDY_LINKS.export(outfile, level, namespace_, name_='STUDY_LINKS', pretty_print=pretty_print)
        if self.STUDY_ATTRIBUTES is not None:
            self.STUDY_ATTRIBUTES.export(outfile, level, namespace_, name_='STUDY_ATTRIBUTES', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='StudyType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(StudyType, self).exportLiteralAttributes(outfile, level, already_processed, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        super(StudyType, self).exportLiteralChildren(outfile, level, name_)
        if self.DESCRIPTOR is not None:
            showIndent(outfile, level)
        ...
        if self.STUDY_LINKS is not None:
            showIndent(outfile, level)
            outfile.write('STUDY_LINKS=model_.STUDY_LINKSType(\n')
            self.STUDY_LINKS.exportLiteral(outfile, level, name_='STUDY_LINKS')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.STUDY_ATTRIBUTES is not None:
            showIndent(outfile, level)
            outfile.write('STUDY_ATTRIBUTES=model_.STUDY_ATTRIBUTESType(\n')
            self.STUDY_ATTRIBUTES.exportLiteral(outfile, level, name_='STUDY_ATTRIBUTES')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
        ...
        return self
    def buildAttributes(self, node, attrs, already_processed):
        super(StudyType, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
...
GDSClassesMapping = {
    ...
    'RELATED_LINK': XRefType,
    'ABI_SOLID': ABI_SOLIDType,
    'STUDY_ATTRIBUTE': AttributeType,
    'RELATED_STUDIES': RELATED_STUDIESType,
    'COMPLETE_GENOMICS': COMPLETE_GENOMICSType,
    'LS454': LS454Type,
    'ILLUMINA': ILLUMINAType,
    'STUDY_TYPE': STUDY_TYPEType,
    'CUSTOM': CUSTOMType,
    'PRIMARY_ID': NameType,
    ...
    'RELATED_STUDY': RELATED_STUDYType,
    'STUDY_ATTRIBUTES': STUDY_ATTRIBUTESType,
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from study_api import *\n\n')
        sys.stdout.write('import study_api as model_\n\n')
