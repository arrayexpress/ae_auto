...
#
# Generated Mon Mar 13 15:45:58 2017 by generateDS.py version 2.16a.
#
...
#   sra_schema_files/SRA.submission.xsd
#
# Command line:
#   /home/gemmy/generateDS-2.16a0/generateDS.py -f -o "submission_api.py" sra_schema_files/SRA.submission.xsd
#
...
class SubmissionSetType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SubmissionSetType'):
        level += 1
        already_processed = set()
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for SUBMISSION_ in self.SUBMISSION:
            showIndent(outfile, level)
            outfile.write('model_.SubmissionType(\n')
            SUBMISSION_.exportLiteral(outfile, level, name_='SubmissionType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class CONTACTSType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='CONTACTSType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class CONTACTType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='CONTACTType'):
        ...
        if self.inform_on_status is not None and 'inform_on_status' not in already_processed:
            ...
            outfile.write(' inform_on_status=%s' % (self.gds_format_string(quote_attrib(self.inform_on_status).encode(ExternalEncoding), input_name='inform_on_status'), ))
        if self.inform_on_error is not None and 'inform_on_error' not in already_processed:
            already_processed.add('inform_on_error')
            outfile.write(' inform_on_error=%s' % (self.gds_format_string(quote_attrib(self.inform_on_error).encode(ExternalEncoding), input_name='inform_on_error'), ))
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.inform_on_status is not None and 'inform_on_status' not in already_processed:
            already_processed.add('inform_on_status')
            showIndent(outfile, level)
            outfile.write('inform_on_status="%s",\n' % (self.inform_on_status,))
        if self.inform_on_error is not None and 'inform_on_error' not in already_processed:
            already_processed.add('inform_on_error')
            showIndent(outfile, level)
            outfile.write('inform_on_error="%s",\n' % (self.inform_on_error,))
    def exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node):
        already_processed = set()
...
class ACTIONType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ADD=None, MODIFY=None, CANCEL=None, SUPPRESS=None, HOLD=None, RELEASE=None, PROTECT=None, ROLLBACK=None, VALIDATE=None):
        self.original_tagname_ = None
        self.ADD = ADD
        self.MODIFY = MODIFY
        self.CANCEL = CANCEL
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ACTIONType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ROLLBACK is not None:
            self.ROLLBACK.export(outfile, level, namespace_, name_='ROLLBACK', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.ADD is not None:
            showIndent(outfile, level)
            outfile.write('ADD=model_.ADDType(\n')
            self.ADD.exportLiteral(outfile, level, name_='ADD')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.MODIFY is not None:
            showIndent(outfile, level)
            outfile.write('MODIFY=model_.MODIFYType(\n')
            self.MODIFY.exportLiteral(outfile, level, name_='MODIFY')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.CANCEL is not None:
            showIndent(outfile, level)
            outfile.write('CANCEL=model_.CANCELType(\n')
            self.CANCEL.exportLiteral(outfile, level, name_='CANCEL')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SUPPRESS is not None:
            showIndent(outfile, level)
            outfile.write('SUPPRESS=model_.SUPPRESSType(\n')
            self.SUPPRESS.exportLiteral(outfile, level, name_='SUPPRESS')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.HOLD is not None:
            showIndent(outfile, level)
            outfile.write('HOLD=model_.HOLDType(\n')
            self.HOLD.exportLiteral(outfile, level, name_='HOLD')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.RELEASE is not None:
            showIndent(outfile, level)
            outfile.write('RELEASE=model_.RELEASEType(\n')
            self.RELEASE.exportLiteral(outfile, level, name_='RELEASE')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.PROTECT is not None:
            showIndent(outfile, level)
            outfile.write('PROTECT=model_.PROTECTType(\n')
            self.PROTECT.exportLiteral(outfile, level, name_='PROTECT')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ROLLBACK is not None:
            showIndent(outfile, level)
            outfile.write('ROLLBACK=model_.ROLLBACKType(\n')
            self.ROLLBACK.exportLiteral(outfile, level, name_='ROLLBACK')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.VALIDATE is not None:
            showIndent(outfile, level)
            outfile.write('VALIDATE=model_.VALIDATEType(\n')
            self.VALIDATE.exportLiteral(outfile, level, name_='VALIDATE')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
...
class ADDType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ADDType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='ADDType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class MODIFYType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='MODIFYType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='MODIFYType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class CANCELType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CANCELType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='CANCELType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class SUPPRESSType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SUPPRESSType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='SUPPRESSType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class HOLDType(GeneratedsSuper):
    ...
    def __init__(self, HoldUntilDate=None, target=None):
        self.original_tagname_ = None
        if isinstance(HoldUntilDate, basestring):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='HOLDType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='HOLDType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.HoldUntilDate is not None and 'HoldUntilDate' not in already_processed:
            already_processed.add('HoldUntilDate')
            showIndent(outfile, level)
            outfile.write('HoldUntilDate=model_.GeneratedsSuper.gds_parse_date("%s"),\n' % self.gds_format_date(self.HoldUntilDate, input_name='HoldUntilDate'))
        if self.target is not None and 'target' not in already_processed:
            already_processed.add('target')
            showIndent(outfile, level)
            outfile.write('target="%s",\n' % (self.target,))
...
class PROTECTType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='PROTECTType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='PROTECTType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ROLLBACKType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ROLLBACKType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ROLLBACKType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='ROLLBACKType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ROLLBACKType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='ROLLBACKType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='ROLLBACKType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class VALIDATEType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='VALIDATEType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='VALIDATEType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class SUBMISSION_LINKSType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SUBMISSION_LINKSType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SUBMISSION_LINK=[\n')
        level += 1
        for SUBMISSION_LINK_ in self.SUBMISSION_LINK:
            showIndent(outfile, level)
            outfile.write('model_.LinkType(\n')
            SUBMISSION_LINK_.exportLiteral(outfile, level, name_='LinkType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SUBMISSION_ATTRIBUTESType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SUBMISSION_ATTRIBUTESType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SUBMISSION_ATTRIBUTE=[\n')
        level += 1
        for SUBMISSION_ATTRIBUTE_ in self.SUBMISSION_ATTRIBUTE:
            showIndent(outfile, level)
            outfile.write('model_.AttributeType(\n')
            SUBMISSION_ATTRIBUTE_.exportLiteral(outfile, level, name_='AttributeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SubmissionType(ObjectType):
    ...
    def __init__(self, center_name=None, alias=None, broker_name=None, accession=None, IDENTIFIERS=None, submission_date=None, lab_name=None, submission_comment=None, TITLE=None, CONTACTS=None, ACTIONS=None, SUBMISSION_LINKS=None, SUBMISSION_ATTRIBUTES=None):
        self.original_tagname_ = None
        super(SubmissionType, self).__init__(center_name, alias, broker_name, accession, IDENTIFIERS, )
    ...
    def hasContent_(self):
        if (
            ...
            super(SubmissionType, self).hasContent_()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='SubmissionType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SubmissionType'):
        super(SubmissionType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='SubmissionType')
        ...
        if self.lab_name is not None and 'lab_name' not in already_processed:
            ...
            outfile.write(' lab_name=%s' % (self.gds_format_string(quote_attrib(self.lab_name).encode(ExternalEncoding), input_name='lab_name'), ))
        if self.submission_comment is not None and 'submission_comment' not in already_processed:
            ...
            outfile.write(' submission_comment=%s' % (self.gds_format_string(quote_attrib(self.submission_comment).encode(ExternalEncoding), input_name='submission_comment'), ))
    def exportChildren(self, outfile, level, namespace_='', name_='SubmissionType', fromsubclass_=False, pretty_print=True):
        super(SubmissionType, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='SubmissionType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.submission_date is not None and 'submission_date' not in already_processed:
            already_processed.add('submission_date')
            showIndent(outfile, level)
            outfile.write('submission_date=model_.GeneratedsSuper.gds_parse_datetime("%s"),\n' % self.gds_format_datetime(self.submission_date, input_name='submission_date'))
        if self.lab_name is not None and 'lab_name' not in already_processed:
            already_processed.add('lab_name')
            showIndent(outfile, level)
            outfile.write('lab_name="%s",\n' % (self.lab_name,))
        if self.submission_comment is not None and 'submission_comment' not in already_processed:
            already_processed.add('submission_comment')
            showIndent(outfile, level)
            outfile.write('submission_comment="%s",\n' % (self.submission_comment,))
        super(SubmissionType, self).exportLiteralAttributes(outfile, level, already_processed, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        super(SubmissionType, self).exportLiteralChildren(outfile, level, name_)
        if self.TITLE is not None:
            showIndent(outfile, level)
            outfile.write('TITLE=%s,\n' % quote_python(self.TITLE).encode(ExternalEncoding))
        if self.CONTACTS is not None:
            showIndent(outfile, level)
            outfile.write('CONTACTS=model_.CONTACTSType(\n')
        ...
        if self.SUBMISSION_LINKS is not None:
            showIndent(outfile, level)
            outfile.write('SUBMISSION_LINKS=model_.SUBMISSION_LINKSType(\n')
            self.SUBMISSION_LINKS.exportLiteral(outfile, level, name_='SUBMISSION_LINKS')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SUBMISSION_ATTRIBUTES is not None:
            showIndent(outfile, level)
            outfile.write('SUBMISSION_ATTRIBUTES=model_.SUBMISSION_ATTRIBUTESType(\n')
            self.SUBMISSION_ATTRIBUTES.exportLiteral(outfile, level, name_='SUBMISSION_ATTRIBUTES')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        super(SubmissionType, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TITLE':
            TITLE_ = child_.text
        ...
        super(SubmissionType, self).buildChildren(child_, node, nodeName_, True)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from submission_api import *\n\n')
        sys.stdout.write('import submission_api as model_\n\n')
