...
#
# Generated Mon Mar 13 15:45:34 2017 by generateDS.py version 2.16a.
#
...
#   sra_schema_files/SRA.sample.xsd
#
# Command line:
#   /home/gemmy/generateDS-2.16a0/generateDS.py -f -o "sample_api.py" sra_schema_files/SRA.sample.xsd
#
...
class SampleSetType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='SampleSetType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='SampleSetType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='SampleSetType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SampleSetType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='SampleSetType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='SampleSetType'):
        level += 1
        already_processed = set()
...
class SAMPLE_NAMEType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, TAXON_ID=None, SCIENTIFIC_NAME=None, COMMON_NAME=None, ANONYMIZED_NAME=None, INDIVIDUAL_NAME=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_TAXON_ID(self): return self.TAXON_ID
    def set_TAXON_ID(self, TAXON_ID): self.TAXON_ID = TAXON_ID
    ...
    def get_ANONYMIZED_NAME(self): return self.ANONYMIZED_NAME
    def set_ANONYMIZED_NAME(self, ANONYMIZED_NAME): self.ANONYMIZED_NAME = ANONYMIZED_NAME
    def get_INDIVIDUAL_NAME(self): return self.INDIVIDUAL_NAME
    def set_INDIVIDUAL_NAME(self, INDIVIDUAL_NAME): self.INDIVIDUAL_NAME = INDIVIDUAL_NAME
    def hasContent_(self):
        if (
            self.TAXON_ID is not None or
            self.SCIENTIFIC_NAME is not None or
            self.COMMON_NAME is not None or
            self.ANONYMIZED_NAME is not None or
            self.INDIVIDUAL_NAME is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='SAMPLE_NAMEType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='SAMPLE_NAMEType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='SAMPLE_NAMEType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SAMPLE_NAMEType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='SAMPLE_NAMEType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.TAXON_ID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTAXON_ID>%s</%sTAXON_ID>%s' % (namespace_, self.gds_format_integer(self.TAXON_ID, input_name='TAXON_ID'), namespace_, eol_))
        if self.SCIENTIFIC_NAME is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSCIENTIFIC_NAME>%s</%sSCIENTIFIC_NAME>%s' % (namespace_, self.gds_format_string(quote_xml(self.SCIENTIFIC_NAME).encode(ExternalEncoding), input_name='SCIENTIFIC_NAME'), namespace_, eol_))
        if self.COMMON_NAME is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCOMMON_NAME>%s</%sCOMMON_NAME>%s' % (namespace_, self.gds_format_string(quote_xml(self.COMMON_NAME).encode(ExternalEncoding), input_name='COMMON_NAME'), namespace_, eol_))
        if self.ANONYMIZED_NAME is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sANONYMIZED_NAME>%s</%sANONYMIZED_NAME>%s' % (namespace_, self.gds_format_string(quote_xml(self.ANONYMIZED_NAME).encode(ExternalEncoding), input_name='ANONYMIZED_NAME'), namespace_, eol_))
        if self.INDIVIDUAL_NAME is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sINDIVIDUAL_NAME>%s</%sINDIVIDUAL_NAME>%s' % (namespace_, self.gds_format_string(quote_xml(self.INDIVIDUAL_NAME).encode(ExternalEncoding), input_name='INDIVIDUAL_NAME'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='SAMPLE_NAMEType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.TAXON_ID is not None:
            showIndent(outfile, level)
            outfile.write('TAXON_ID=%d,\n' % self.TAXON_ID)
        if self.SCIENTIFIC_NAME is not None:
            showIndent(outfile, level)
            outfile.write('SCIENTIFIC_NAME=%s,\n' % quote_python(self.SCIENTIFIC_NAME).encode(ExternalEncoding))
        if self.COMMON_NAME is not None:
            showIndent(outfile, level)
            outfile.write('COMMON_NAME=%s,\n' % quote_python(self.COMMON_NAME).encode(ExternalEncoding))
        if self.ANONYMIZED_NAME is not None:
            showIndent(outfile, level)
            outfile.write('ANONYMIZED_NAME=%s,\n' % quote_python(self.ANONYMIZED_NAME).encode(ExternalEncoding))
        if self.INDIVIDUAL_NAME is not None:
            showIndent(outfile, level)
            outfile.write('INDIVIDUAL_NAME=%s,\n' % quote_python(self.INDIVIDUAL_NAME).encode(ExternalEncoding))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TAXON_ID':
            ...
            self.COMMON_NAME = COMMON_NAME_
        elif nodeName_ == 'ANONYMIZED_NAME':
            ANONYMIZED_NAME_ = child_.text
            ANONYMIZED_NAME_ = self.gds_validate_string(ANONYMIZED_NAME_, node, 'ANONYMIZED_NAME')
            self.ANONYMIZED_NAME = ANONYMIZED_NAME_
        elif nodeName_ == 'INDIVIDUAL_NAME':
            INDIVIDUAL_NAME_ = child_.text
            INDIVIDUAL_NAME_ = self.gds_validate_string(INDIVIDUAL_NAME_, node, 'INDIVIDUAL_NAME')
            self.INDIVIDUAL_NAME = INDIVIDUAL_NAME_
...
class SAMPLE_LINKSType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, SAMPLE_LINK=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_SAMPLE_LINK(self): return self.SAMPLE_LINK
    def set_SAMPLE_LINK(self, SAMPLE_LINK): self.SAMPLE_LINK = SAMPLE_LINK
    def add_SAMPLE_LINK(self, value): self.SAMPLE_LINK.append(value)
    def insert_SAMPLE_LINK_at(self, index, value): self.SAMPLE_LINK.insert(index, value)
    def replace_SAMPLE_LINK_at(self, index, value): self.SAMPLE_LINK[index] = value
    def hasContent_(self):
        if (
            self.SAMPLE_LINK
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='SAMPLE_LINKSType', namespacedef_=' xmlns:com="SRA.common" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='SAMPLE_LINKSType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='SAMPLE_LINKSType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SAMPLE_LINKSType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='SAMPLE_LINKSType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for SAMPLE_LINK_ in self.SAMPLE_LINK:
            SAMPLE_LINK_.export(outfile, level, namespace_, name_='SAMPLE_LINK', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='SAMPLE_LINKSType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SAMPLE_LINK=[\n')
        level += 1
        for SAMPLE_LINK_ in self.SAMPLE_LINK:
            showIndent(outfile, level)
            outfile.write('model_.LinkType(\n')
            SAMPLE_LINK_.exportLiteral(outfile, level, name_='LinkType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SAMPLE_ATTRIBUTESType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, SAMPLE_ATTRIBUTE=None):
        self.original_tagname_ = None
    ...
    factory = staticmethod(factory)
    def get_SAMPLE_ATTRIBUTE(self): return self.SAMPLE_ATTRIBUTE
    def set_SAMPLE_ATTRIBUTE(self, SAMPLE_ATTRIBUTE): self.SAMPLE_ATTRIBUTE = SAMPLE_ATTRIBUTE
    def add_SAMPLE_ATTRIBUTE(self, value): self.SAMPLE_ATTRIBUTE.append(value)
    def insert_SAMPLE_ATTRIBUTE_at(self, index, value): self.SAMPLE_ATTRIBUTE.insert(index, value)
    def replace_SAMPLE_ATTRIBUTE_at(self, index, value): self.SAMPLE_ATTRIBUTE[index] = value
    def hasContent_(self):
        if (
            self.SAMPLE_ATTRIBUTE
        ):
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='SAMPLE_ATTRIBUTESType', namespacedef_=' xmlns:com="SRA.common" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='SAMPLE_ATTRIBUTESType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='SAMPLE_ATTRIBUTESType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SAMPLE_ATTRIBUTESType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='SAMPLE_ATTRIBUTESType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for SAMPLE_ATTRIBUTE_ in self.SAMPLE_ATTRIBUTE:
            SAMPLE_ATTRIBUTE_.export(outfile, level, namespace_, name_='SAMPLE_ATTRIBUTE', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='SAMPLE_ATTRIBUTESType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SAMPLE_ATTRIBUTE=[\n')
        level += 1
        for SAMPLE_ATTRIBUTE_ in self.SAMPLE_ATTRIBUTE:
            showIndent(outfile, level)
            outfile.write('model_.AttributeType(\n')
            SAMPLE_ATTRIBUTE_.exportLiteral(outfile, level, name_='AttributeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SampleType(ObjectType):
    ...
    sequencing experiments can be based. The Sample object may be a
    surrogate for taxonomy accession or an anonymized individual
    identifier. Or, it may fully specify provenance and isolation
    method of the starting material."""
    subclass = None
    superclass = ObjectType
    def __init__(self, center_name=None, alias=None, broker_name=None, accession=None, IDENTIFIERS=None, TITLE=None, SAMPLE_NAME=None, DESCRIPTION=None, SAMPLE_LINKS=None, SAMPLE_ATTRIBUTES=None):
        self.original_tagname_ = None
        super(SampleType, self).__init__(center_name, alias, broker_name, accession, IDENTIFIERS, )
        self.TITLE = TITLE
    ...
    def get_SAMPLE_NAME(self): return self.SAMPLE_NAME
    def set_SAMPLE_NAME(self, SAMPLE_NAME): self.SAMPLE_NAME = SAMPLE_NAME
    def get_DESCRIPTION(self): return self.DESCRIPTION
    def set_DESCRIPTION(self, DESCRIPTION): self.DESCRIPTION = DESCRIPTION
    def get_SAMPLE_LINKS(self): return self.SAMPLE_LINKS
    def set_SAMPLE_LINKS(self, SAMPLE_LINKS): self.SAMPLE_LINKS = SAMPLE_LINKS
    def get_SAMPLE_ATTRIBUTES(self): return self.SAMPLE_ATTRIBUTES
    def set_SAMPLE_ATTRIBUTES(self, SAMPLE_ATTRIBUTES): self.SAMPLE_ATTRIBUTES = SAMPLE_ATTRIBUTES
    def hasContent_(self):
        if (
            ...
            super(SampleType, self).hasContent_()
        ):
            return True
        else:
            return False
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SampleType'):
        super(SampleType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='SampleType')
    def exportChildren(self, outfile, level, namespace_='', name_='SampleType', fromsubclass_=False, pretty_print=True):
        super(SampleType, self).exportChildren(outfile, level, namespace_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.SAMPLE_NAME is not None:
            self.SAMPLE_NAME.export(outfile, level, namespace_, name_='SAMPLE_NAME', pretty_print=pretty_print)
        if self.DESCRIPTION is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDESCRIPTION>%s</%sDESCRIPTION>%s' % (namespace_, self.gds_format_string(quote_xml(self.DESCRIPTION).encode(ExternalEncoding), input_name='DESCRIPTION'), namespace_, eol_))
        if self.SAMPLE_LINKS is not None:
            self.SAMPLE_LINKS.export(outfile, level, namespace_, name_='SAMPLE_LINKS', pretty_print=pretty_print)
        if self.SAMPLE_ATTRIBUTES is not None:
            self.SAMPLE_ATTRIBUTES.export(outfile, level, namespace_, name_='SAMPLE_ATTRIBUTES', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='SampleType'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(SampleType, self).exportLiteralAttributes(outfile, level, already_processed, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        super(SampleType, self).exportLiteralChildren(outfile, level, name_)
        if self.TITLE is not None:
            showIndent(outfile, level)
            outfile.write('TITLE=%s,\n' % quote_python(self.TITLE).encode(ExternalEncoding))
        if self.SAMPLE_NAME is not None:
            showIndent(outfile, level)
            outfile.write('SAMPLE_NAME=model_.SAMPLE_NAMEType(\n')
            self.SAMPLE_NAME.exportLiteral(outfile, level, name_='SAMPLE_NAME')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.DESCRIPTION is not None:
            showIndent(outfile, level)
        ...
        if self.SAMPLE_LINKS is not None:
            showIndent(outfile, level)
            outfile.write('SAMPLE_LINKS=model_.SAMPLE_LINKSType(\n')
            self.SAMPLE_LINKS.exportLiteral(outfile, level, name_='SAMPLE_LINKS')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SAMPLE_ATTRIBUTES is not None:
            showIndent(outfile, level)
            outfile.write('SAMPLE_ATTRIBUTES=model_.SAMPLE_ATTRIBUTESType(\n')
            self.SAMPLE_ATTRIBUTES.exportLiteral(outfile, level, name_='SAMPLE_ATTRIBUTES')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
        ...
        return self
    def buildAttributes(self, node, attrs, already_processed):
        super(SampleType, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TITLE':
            TITLE_ = child_.text
...
GDSClassesMapping = {
    ...
    'SAMPLE_LINK': LinkType,
    'SAMPLE_ATTRIBUTES': SAMPLE_ATTRIBUTESType,
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from sample_api import *\n\n')
        sys.stdout.write('import sample_api as model_\n\n')
